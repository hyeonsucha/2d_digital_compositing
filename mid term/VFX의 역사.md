...
1-5. 최초의 CG영화 : '스페이스 오디세이'
-----------------------------------------
VFX에 CG를 활용한 최초의 장편영화는 1968년에 개봉한 '스페이스 오디세이 2001'이다. 조지 루카스 감독은 1977년에 개봉한 '스타워즈'가 성공하자 자신의 영화사에 CG 담당 부서를 설립했으며, 이후 CG는 영화 제작의 기본 요소로 서서히 자리 잡기 시작했다.


1-6. 최초의 FULL 3D CG 영화 : '트론'
-------------------------------
...
터미네이터2는 '윌로우'의 모핑 기법을 3차원으로 발전시켜 T-1000이라는 캐릭터를 만들어냈다. 

'쥬라기 공원'은 CG공룡들이 보여준 사실적인 모습으로 대중들에게 CGI(CG로 만들어진 이미지) 시대를 연 대표작이 되었다. CG뿐 아니라 조종할 수 있는 로봇을 사용하기도 했다.
...
3-1. 클라우드 기반 렌더링
-------------------------
기존에 고해상도의 렌더링 작업을 수행해야 하는 기업들은 렌더팜을 직접 구성하거나 임대해 사용하는 데 비용과 시간, 인력을 소모해야 했다. 클라우드 컴퓨팅은 필요한 때 원하는 만큼의 IT 자원을 사용할 수 있게 해 줌으로써 렌더링에 필요한 시간을 최소한으로 단축할 수 있게 한다. 
