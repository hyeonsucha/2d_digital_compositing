...
영화 ‘미스터 고’에서는 고릴라의 털을 매우 사실적인 CG로 만드는데 성공했다.
...
배우의 연기와 얼굴의 움직임을 저해상도로 스캔해 고해상도 메시에 정확하게 적용하는 마스커레이드(Masquerade)라는 머신 러닝 시스템이 있다. 마스커레이드 기술을 통해 VFX 아티스트들은 미묘한 얼굴 움직임을 수작업으로 애니메이션화하여 사실적이고 감정을 과장되게 연기하는 디지털 휴먼을 생성하는데 소요되는 매우 긴 시간을 단축했다.
